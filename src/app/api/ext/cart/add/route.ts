  ...
  try {
    const row = await prisma.gioMuaHo.create({
      data: {
        ...
        danhMuc: b.danhMuc != null && String(b.danhMuc).trim() ? String(b.danhMuc).trim() : null,
        note: b.note != null ? String(b.note) : null,
        ghiChuRiengTu: b.ghiChuRiengTu != null && String(b.ghiChuRiengTu).trim() ? String(b.ghiChuRiengTu).trim() : null,
